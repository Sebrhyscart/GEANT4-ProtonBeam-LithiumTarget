...
G4VPhysicalVolume *MyDetectorConstruction::Construct()
{
    ...
    G4double RTunnel = 5.*cm; //radius of access tunnel in shielding cube
    G4double RTarget = 3.*cm; //Target radius
    ...
    //Define World -> in this case, world = concrete shieling box
    G4Box *solidWorld = new G4Box("solidWorld", LCube, LCube, LCube);
    G4LogicalVolume *logicWorld = new G4LogicalVolume(solidWorld, concrete, "logicWorld");
    ...
    G4VPhysicalVolume *physTaget = new G4PVPlacement(0, xyzTarget, logicTarget, "physTarget",
        logicVacuumTunnel, false, 0, true);
